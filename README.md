...
# Welcome to CommonSpirit Health Real Estate Construction Services - Low Voltage Requirements & Specifications

# This is an Enterprise Architecture Project Documentation repository. 
	
# This repository will contain all the documentation and templates required for the telecommunications infrastructure project in a healthcare facility. 
	
-[Below is a guide to help vendors get started, fill out necessary portions, and submit completed documents.]
...
**Enterprise Low Voltage Architecture**
...
|				     | [06_BTU_Cooling_Calculations.md](./40_Installation_and_Testing/06_BTU_Cooling_Calculations.md)			    |BTU Calculation basics for proper cooling and BTU/hr calculations based on Watts x 3.412  | N  |
...
Several documents contain fields that need to be filled out by you. 
These are indicated in the "Fields to Fill Out" column in the Table of Contents. 
